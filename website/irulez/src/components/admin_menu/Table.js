...
class EnhancedTable extends React.Component {
    ...
    showContent = value => {
        this.setState({ popupData: value });
        this.setState({ popupOpen: true });
    };

    checkType = (field, n, classes) => {
        if (field.id in n) {
            switch (field.type) {
                case 'ErrorCheck':
                    return n[field.id] === 1 ? (
                    ...
                    if (n[field.id]) {
                        return (
                            <Button
                                ...
                                onClick={() => this.showContent(n[field.id])}
                            >
                                view
                            </Button>
                        );
        ...
        return (
            <Paper className={classes.root}>
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            selected={isSelected}
                                        >
                                            <TableCell padding='checkbox' onClick={event => this.handleClick(event, n)}>
                                                    ...
                                                    if (field.id === 'id') {
                                                        ...
                                                        return (
                                                            <TableCell key={field.id}>
                                                                {this.checkType(field, n, classes)}
                                                            </TableCell>
                                                        );
                                                    }
                                                })}
                ...
                <PopupMenu
                    ...
                    handleFormClose={() => this.setState({ popupOpen: false })}
                    title='Outputs'
