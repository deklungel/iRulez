...
{ 
	this.EditableGrid = new EditableGrid("Core_Arduino_Outputs", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_outputs.php?db_tablename=Core_Arduino_Outputs");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Ben je zeker dat je alle Arduinos met nummer ' + id + ' wil verwijderen?')  ) {

        $.ajax({
		url: 'delete_output.php',
		type: 'POST',
		dataType: "html",
		data: {
