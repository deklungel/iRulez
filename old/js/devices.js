...
{ 
	this.EditableGrid = new EditableGrid("Core_Devices", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_devices.php?db_tablename=Core_Devices");
};
...
// render for the action column
	...
	grid.setCellRenderer("MQTT", new CellRenderer({ 
		render: function(cell, value) {                 
				if(value >= 2){
					cell.innerHTML = "<i class='fa red fa-exclamation-triangle'></i>";
				}
				else{
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
 ...
 if ( confirm(Device_delete.replace('$', id))  ) {
