...
{ 
	this.EditableGrid = new EditableGrid("html_Radio_zenders", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_PlayList.php?db_tablename=html_Radio_zenders");
};
...
// render for the action column
	...
	grid.setCellRenderer("edit", new CellRenderer({ 
		render: function(cell, id) {                 
				cell.innerHTML+= '<a class="btn btn-default btn-sm" href="edit.php?table=editPlayList&id='+id+'"><i class="fa fa-cog"></i> '+PlayList_setting+'</a>';
		}
	})); 
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm(PlayList_delete.replace('$', id))  ) {
