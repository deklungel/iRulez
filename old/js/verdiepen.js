...
{ 
	this.EditableGrid = new EditableGrid("html_verdiep", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_verdiepen.php?db_tablename=html_verdiep");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm(verdiepen_delete.replace('$', id))  ) {
