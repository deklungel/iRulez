...
{ 
	this.EditableGrid = new EditableGrid("Owntracks_action", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_owntracks_action.php?db_tablename=Owntracks_action");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm(Owntrack_Action_del.replace('$', id))  ) {
...
DatabaseGrid.prototype.addRow = function(id) 
{
  ...
  var self = this;
		...
		data: {
			...
			Core_vButtonDB: $("#Core_vButtonDB").val(),
			OwnTracks_event: $("#OwnTracks_event").val()
