...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_radiozender.php?db_tablename=html_Radio_zenders");
};
...
// render for the action column
	...
	grid.setCellRenderer("soort", new CellRenderer({ 
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm(Radio_delete.replace('$', id))  ) {

        $.ajax({
		url: 'delete_radioZender.php',
		type: 'POST',
		dataType: "html",
		data: {
