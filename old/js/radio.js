...
{ 
	this.EditableGrid = new EditableGrid("html_Radio", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_radio.php?db_tablename=html_Radio");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Ben je zeker dat je Radio met id ' + id + ' wil verwijderen?')  ) {
