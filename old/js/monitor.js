...
{ 
	this.EditableGrid = new EditableGrid("Monitor_Devices", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_monitor.php?db_tablename=Monitor_Devices");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm(Monitor_delete.replace('$', id))  ) {
