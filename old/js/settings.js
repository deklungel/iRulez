...
{ 
	this.EditableGrid = new EditableGrid("Settings", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.EditableGrid.loadJSON("loaddata_settings.php?db_tablename=Settings");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Ben je zeker dat je Settings met id ' + id + ' wil verwijderen?')  ) {
